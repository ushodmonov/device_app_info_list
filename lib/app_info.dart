...
import 'package:device_app_info_list/app_category.dart';
import 'package:device_app_info_list/platform_type.dart';
...
class AppInfo {
  ...
  /// Installer package name (e.g. "com.android.vending" for Play Store), null if unknown/sideloaded.
