...
import uz.ushodmonov.device_app_info_list.Util.Companion.convertAppToMap
import uz.ushodmonov.device_app_info_list.Util.Companion.getLaunchablePackageNames
import uz.ushodmonov.device_app_info_list.Util.Companion.getPackageInfo
import uz.ushodmonov.device_app_info_list.Util.Companion.getPackageManager
import uz.ushodmonov.device_app_info_list.Util.Companion.isSystemApp
...
class InstalledAppsPlugin : MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(binding.binaryMessenger, "device_app_info_list")
